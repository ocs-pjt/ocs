# HACK simple_form to support Boostrap 3
inputs = %w[
...
SimpleForm.setup do |config|
  ...
  # whole input.
  config.wrappers :bootstrap3, tag: 'div', class: 'row' do |row|
    row.wrapper tag: 'div', class: 'form-group col-md-4', error_class: 'has-error',
